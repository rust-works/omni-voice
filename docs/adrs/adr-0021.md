...
> No longer applies: the MCP server (second binary) this decision governed was removed in the strip-to-voice-cli refactor (issue [#36](https://github.com/rust-works/omni-voice/issues/36)). Retained as a historical record of the original rationale.

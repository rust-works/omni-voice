...
|---|---|
| [Adding an AI backend](adding-an-ai-backend.md) | You want omni-voice to drive a new model provider for `voice reflect` (a new sibling of [`src/claude/ai/claude.rs`](../../src/claude/ai/claude.rs), [`openai.rs`](../../src/claude/ai/openai.rs), [`bedrock.rs`](../../src/claude/ai/bedrock.rs), [`claude_cli.rs`](../../src/claude/ai/claude_cli.rs)). |
